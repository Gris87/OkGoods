...
public final class MainDatabase extends SQLiteOpenHelper
{
    ...
    // Autogenerated code. Please do not modify manually
    ...
    private static final int CITY_ID_SURGUT           = 22;
    private static final int CITY_ID_SYKTYVKAR        = 23;
    private static final int CITY_ID_TOLYATTI         = 24;
    private static final int CITY_ID_TYUMEN           = 25;
    private static final int CITY_ID_UFA              = 26;
    ...
    private static final int SHOP_ID_MOSCOW_HYPERMARKET_OK_SVYATOOZERSKAYA                               = 44356;
    ...
    private static final int SHOP_ID_ST_PETERSBURG_HYPERMARKET_OK_RIVER_HOUSE                            = 141996;
    private static final int SHOP_ID_ST_PETERSBURG_SUPERMARKET_OK_SESTRORETSK                            = 154692;
    ...
    private static final int SHOP_ID_TYUMEN_HYPERMARKET_OK_TYUMEN_PROFSOYUZNAYA                          = 49191;
    ...
    private void fillShopsTable(SQLiteDatabase db)
    {
        ...
        insertToTable(db, SHOPS_TABLE_NAME, SHOPS_COLUMNS,
                ...
                "+7 (495) 213-32-61",                                                               // COLUMN_PHONE
                "08:00 до 23:00",                                                                   // COLUMN_WORK_HOURS
                11300,                                                                              // COLUMN_SQUARE
        ...
        insertToTable(db, SHOPS_TABLE_NAME, SHOPS_COLUMNS,
                SHOP_ID_MOSCOW_HYPERMARKET_OK_SVYATOOZERSKAYA,                                          // COLUMN_ID
                CITY_ID_MOSCOW,                                                                         // COLUMN_CITY_ID
                mContext.getResources().getString(R.string.shop_moscow_hypermarket_ok_svyatoozerskaya), // COLUMN_NAME
                SHOP_HYPERMARKET,                                                                       // COLUMN_IS_HYPERMARKET
                55.714706258945,                                                                        // COLUMN_LATITUDE
                37.883917229051,                                                                        // COLUMN_LONGITUDE
                "+7 (495) 795-09-86",                                                                   // COLUMN_PHONE
                "8:00 - 24:00",                                                                         // COLUMN_WORK_HOURS
                0,                                                                                      // COLUMN_SQUARE
                "",                                                                                     // COLUMN_OPENING_DATE
                0,                                                                                      // COLUMN_PARKING_PLACES
        ...
        insertToTable(db, SHOPS_TABLE_NAME, SHOPS_COLUMNS,
                ...
                "+7 (812) 448-81-70",                                                                       // COLUMN_PHONE
                "9:00 - 24:00",                                                                             // COLUMN_WORK_HOURS
                704,                                                                                        // COLUMN_SQUARE
                "21.12.2007",                                                                               // COLUMN_OPENING_DATE
                8,                                                                                          // COLUMN_PARKING_PLACES
                0,                                                                                          // COLUMN_NUMBER_OF_CASHBOXES
                SERVICE_CLEARING_SETTLEMENT_MASK |                                                          // COLUMN_SERVICES_SET
                        SERVICE_FISH_ISLAND_MASK |
                        SERVICE_BAKERY_MASK      |
        ...
        insertToTable(db, SHOPS_TABLE_NAME, SHOPS_COLUMNS,
                ...
                SHOP_HYPERMARKET,                                                                                   // COLUMN_IS_HYPERMARKET
                59.843501073994,                                                                                    // COLUMN_LATITUDE
                30.179249490768,                                                                                    // COLUMN_LONGITUDE
                "+7 (812) 449-10-56",                                                                               // COLUMN_PHONE
                "8:00-23:00",                                                                                       // COLUMN_WORK_HOURS
                7914,                                                                                               // COLUMN_SQUARE
        ...
        insertToTable(db, SHOPS_TABLE_NAME, SHOPS_COLUMNS,
                SHOP_ID_ST_PETERSBURG_HYPERMARKET_OK_RIVER_HOUSE,                                           // COLUMN_ID
                CITY_ID_ST_PETERSBURG,                                                                      // COLUMN_CITY_ID
                mContext.getResources().getString(R.string.shop_st_petersburg_hypermarket_ok_river_house),  // COLUMN_NAME
                SHOP_HYPERMARKET,                                                                           // COLUMN_IS_HYPERMARKET
                59.977588716079,                                                                            // COLUMN_LATITUDE
                30.317724885688,                                                                            // COLUMN_LONGITUDE
                "+7 (812) 449-12-18",                                                                       // COLUMN_PHONE
                "8:00-23:00",                                                                               // COLUMN_WORK_HOURS
                2700,                                                                                       // COLUMN_SQUARE
                "16.12.2016",                                                                               // COLUMN_OPENING_DATE
                0,                                                                                          // COLUMN_PARKING_PLACES
                18,                                                                                         // COLUMN_NUMBER_OF_CASHBOXES
                SERVICE_CLEARING_SETTLEMENT_MASK   |                                                        // COLUMN_SERVICES_SET
                        SERVICE_FISH_ISLAND_MASK   |
                        SERVICE_BAKERY_MASK        |
                        SERVICE_COOKERY_MASK       |
        ...
        insertToTable(db, SHOPS_TABLE_NAME, SHOPS_COLUMNS,
                SHOP_ID_ST_PETERSBURG_SUPERMARKET_OK_SESTRORETSK,                                           // COLUMN_ID
                CITY_ID_ST_PETERSBURG,                                                                      // COLUMN_CITY_ID
                mContext.getResources().getString(R.string.shop_st_petersburg_supermarket_ok_sestroretsk),  // COLUMN_NAME
                SHOP_SUPERMARKET,                                                                           // COLUMN_IS_HYPERMARKET
                60.084280063932,                                                                            // COLUMN_LATITUDE
                29.954747440475,                                                                            // COLUMN_LONGITUDE
                "+7 (812) 448-21-49",                                                                       // COLUMN_PHONE
                "8:00 - 24:00",                                                                             // COLUMN_WORK_HOURS
                1332,                                                                                       // COLUMN_SQUARE
                "21.04.2017",                                                                               // COLUMN_OPENING_DATE
                6070,                                                                                       // COLUMN_PARKING_PLACES
                11,                                                                                         // COLUMN_NUMBER_OF_CASHBOXES
                SERVICE_CLEARING_SETTLEMENT_MASK |                                                          // COLUMN_SERVICES_SET
                        SERVICE_FISH_ISLAND_MASK |
                        SERVICE_BAKERY_MASK      |
                        SERVICE_COOKERY_MASK     |
        ...
        insertToTable(db, SHOPS_TABLE_NAME, SHOPS_COLUMNS,
                ...
                "+7 (8212) 409-500, +7 (8212) 409-500 - блюда на заказ",                                                // COLUMN_PHONE
                "9:00 - 23:00",                                                                                         // COLUMN_WORK_HOURS
                0,                                                                                                      // COLUMN_SQUARE
                "",                                                                                                     // COLUMN_OPENING_DATE
                1500,                                                                                                   // COLUMN_PARKING_PLACES
        ...
        insertToTable(db, SHOPS_TABLE_NAME, SHOPS_COLUMNS,
                SHOP_ID_TYUMEN_HYPERMARKET_OK_TYUMEN_PROFSOYUZNAYA,                                             // COLUMN_ID
                CITY_ID_TYUMEN,                                                                                 // COLUMN_CITY_ID
                mContext.getResources().getString(R.string.shop_tyumen_hypermarket_ok_tyumen_profsoyuznaya),    // COLUMN_NAME
                SHOP_HYPERMARKET,                                                                               // COLUMN_IS_HYPERMARKET
                57.159739590392,                                                                                // COLUMN_LATITUDE
                65.570014042328,                                                                                // COLUMN_LONGITUDE
                "8 (3452) 49-44-91",                                                                            // COLUMN_PHONE
                "9:00-24:00",                                                                                   // COLUMN_WORK_HOURS
                8000,                                                                                           // COLUMN_SQUARE
                "09.09.2016",                                                                                   // COLUMN_OPENING_DATE
                416,                                                                                            // COLUMN_PARKING_PLACES
                38,                                                                                             // COLUMN_NUMBER_OF_CASHBOXES
                SERVICE_CLEARING_SETTLEMENT_MASK   |                                                            // COLUMN_SERVICES_SET
                        SERVICE_COSMETICS_MASK     |
                        SERVICE_PLAYGROUND_MASK    |
